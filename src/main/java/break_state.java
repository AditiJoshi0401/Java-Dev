public class decision_making {
    public static void main(String args[]) {
         ...
         * case condition_value_1:
         * <do stuff>
         * case condition_value_2:
         * <do_stuff>
         * default:
         * <do stuff any ways if not match>
         * }
         */

        String condition_value = "random";
        ...
        switch (condition_value) {
            ...
            case "Add":
                ...
                break;
            case "Sub":
                System.out.println("Substraction of b from a. A-B=" + String.valueOf(a - b));
                break;
        }
    }
}